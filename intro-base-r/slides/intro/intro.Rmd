...
3. View and download workshop materials at [repository](https://github.com/antchau/workshops/tree/master/intro-base-r) 
]
...
- Flexible and extensible
    - Create novel scientific visualizations 
    - Automate periodic reports for your business, lab, team.
    - Develop statistical tools (Professor Daniel Gillen’s `RCT` package for
    clinical trials)
]
